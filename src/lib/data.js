    ...
    materie: [
      {
        ...
        riassunto: '"La mattanza" di Carlo Lucarelli (2017) ripercorre la storia della mafia in Italia, dagli eventi del processo di Bari dell 11 giugno 1969 fino al declino di Cosa Nostra e all\' ascesa della Ndrangheta. Il libro descrive figure chiave come Totò Riina, Leoluca Bagarella e Bernardo Provenzano, e vittime illustri come Falcone e Borsellino. Il titolo riprende metaforicamente la tradizionale pesca del tonno per descrivere la sistematica eliminazione dei nemici della mafia. Tra gli eventi trattati: la guerra dei Corleonesi, il sacco di Palermo, le stragi di Capaci e via D\'Amelio, l\'operazione Mani Pulite e il crollo della Prima Repubblica. La strage di via D\'Amelio del 19 luglio 1992 uccise Borsellino e cinque agenti della scorta con un\'autobomba di circa 100 kg di esplosivo. Le indagini furono caratterizzate da depistaggi fino alle rivelazioni del pentito Spatuzza nel 2008.',
        puntiChiave: [
          'Processo di Bari 1969: momento cruciale nella lotta contro la mafia',
          'Figure chiave: Totò Riina, Bagarella, Provenzano; vittime: Falcone, Borsellino, Dalla Chiesa',
          'La metafora della mattanza: dalla pesca del tonno all\'eliminazione sistematica dei nemici',
          'Stragi di Capaci e via D\'Amelio (1992): la risposta dello Stato con il 41bis e il pool antimafia',
          'Operazione Mani Pulite e crollo della Prima Repubblica: legame tra corruzione politica e mafia',
          'Declino di Cosa Nostra e ascesa della \'Ndrangheta: la mafia come fenomeno dinamico',
          'Strage via D\'Amelio: depistaggi, Scarantino, rivelazioni di Spatuzza nel 2008',
          'Ipotesi della trattativa Stato-mafia come movente dell\'eliminazione di Borsellino',
        ],
        note: 'La mattanza è anche una metafora usata in letteratura per descrivere stragi e violenze collettive.',
        tags: ['Tradizione', 'Ambiente', 'Cultura']
      },
      {
        id: 'terza-informatica',
        materia: 'Informatica',
        icona: '💻',
        titolo: 'Calcolatore del Codice Fiscale in C',
        tipo: 'Progetto',
        formato: 'Programma C',
        riassunto: 'Abbiamo realizzato un programma in linguaggio C che, a partire dai dati anagrafici dell\'utente (nome, cognome, data di nascita, sesso e comune di nascita), calcola automaticamente il codice fiscale italiano. Il programma applica l\'algoritmo ufficiale dell\'Agenzia delle Entrate: estrazione delle consonanti/vocali da nome e cognome, codifica della data di nascita e del comune tramite il codice catastale, e calcolo del carattere di controllo finale.',
        puntiChiave: [
          'Linguaggio C: strutture dati, stringhe e array',
          'Algoritmo ufficiale Agenzia delle Entrate per il CF',
          'Estrazione consonanti e vocali da nome e cognome',
          'Codifica data di nascita con lettera del mese',
          'Utilizzo del codice catastale del comune di nascita',
          'Calcolo del carattere di controllo (checksum)'
        ],
        note: 'Collegamento civico: il Codice Fiscale è lo strumento con cui lo Stato italiano identifica ogni cittadino. È stato introdotto nel 1973 e gestito dall\'Agenzia delle Entrate.',
        tags: ['Programmazione', 'C', 'Algoritmo', 'Identità digitale']
      },
      {
        id: 'terza-storia',
        materia: 'Storia',
        ...
        tipo: 'Progetto',
        formato: 'PowerPoint',
        riassunto: 'Presentazione PowerPoint sul fenomeno della zoomafia: l\'insieme dei traffici illegali che riguardano gli animali gestiti dalla criminalità organizzata. Il fenomeno comprende il traffico di specie protette, le corse clandestine di cavalli e levrieri, i combattimenti tra animali (cani, galli), il bracconaggio e la macellazione clandestina. In Italia il fenomeno è monitorato annualmente dall\'associazione Zoomafia di LAV.',
        puntiChiave: [
          'Definizione di zoomafia e principali reati coinvolti',
          'Traffico di specie protette: CITES e normativa internazionale',
          'Combattimenti clandestini: cani e galli, radici culturali e criminalità',
          'Bracconaggio e macellazione clandestina: dati e territori',
          "Il ruolo della camorra, 'ndrangheta e cosa nostra",
          'Normativa italiana: legge 189/2004 sui maltrattamenti animali'
        ],
        note: 'La relazione annuale Zoomafia di LAV è la fonte principale in Italia per monitorare questi crimini.',
        tags: ['Criminalità', 'Animali', 'Legalità', 'Mafia']
      }
    ]
  },
  {
    ...
    materie: [
      {
        id: 'quarta-informatica',
        materia: 'Informatica',
        icona: '💻',
        titolo: 'Quiz della Patente in Python',
        tipo: 'Progetto',
        formato: 'Applicazione Python',
        riassunto: 'Abbiamo sviluppato in Python un\'applicazione per esercitarsi con i quiz della patente di guida italiana. L\'app propone domande a risposta multipla estratte da un database, tiene traccia delle risposte corrette e sbagliate, calcola il punteggio finale e segnala le domande in cui si è commesso un errore. Il progetto ha permesso di approfondire la gestione di file, dizionari, cicli e la logica di un\'applicazione interattiva.',
        puntiChiave: [
          'Python: dizionari, liste, cicli e funzioni',
          'Gestione di file per caricare le domande (JSON o CSV)',
          'Logica di esame: 40 domande, max 4 errori per passare',
          'Feedback immediato su risposta corretta/sbagliata',
          'Riepilogo finale con punteggio e domande sbagliate',
          'Collegamento civico: il Codice della Strada e la sicurezza stradale'
        ],
        note: 'Collegamento Ed. Civica: in Italia ogni anno muoiono circa 3.000 persone sulle strade. La patente e il rispetto del Codice della Strada sono strumenti di cittadinanza responsabile.',
        tags: ['Programmazione', 'Python', 'Sicurezza stradale', 'Quiz']
      },
      {
        id: 'quarta-storia',
        materia: 'Storia',
        icona: '📜',
        titolo: 'Popoli Antichi',
        tipo: 'Progetto',
        formato: 'PowerPoint',
        riassunto: 'Presentazione PowerPoint dedicata allo studio di antiche civiltà e popoli della storia, con analisi delle loro strutture sociali, politiche, economiche e culturali. Il lavoro ha permesso di confrontare diverse forme di organizzazione della società umana nelle epoche passate, evidenziando le radici di molti principi civici moderni come la legge, la giustizia e la partecipazione pubblica.',
        puntiChiave: [
          'Organizzazione politica dei popoli antichi: monarchie, oligarchie, democrazie',
          'Le prime codificazioni del diritto: Codice di Hammurabi, leggi di Solone',
          'Struttura sociale: caste, classi, schiavitù e libertà',
          'Ruolo della religione nella vita pubblica e nella legittimazione del potere',
          'Le radici della democrazia: Atene e la partecipazione dei cittadini',
          'Confronto con le istituzioni democratiche contemporanee'
        ],
        note: 'Lo studio dei popoli antichi permette di comprendere come l\'idea di "cittadinanza" si sia evoluta nel corso dei millenni.',
        tags: ['Storia antica', 'Civiltà', 'Democrazia', 'Diritto']
      }
    ]
  },
  {
...
export const tutteLeMaterie = anni.flatMap(a => a.materie.map(m => ({ ...m, annoId: a.id, annoTitolo: a.titolo, annoColore: a.colore })));

export const statistiche = {
  totaleProgetti: tutteLeMaterie.length,
  anniCoperti: anni.length,
  materieDiverse: [...new Set(tutteLeMaterie.map(m => m.materia))].length,
  progettiCodice: tutteLeMaterie.filter(m => m.tags.includes('Programmazione') || m.formato.includes('Python') || m.formato.includes('Django') || m.formato.includes('C')).length,
};
